...
import gsap from 'gsap';
import { ScrollTrigger } from 'gsap/ScrollTrigger';
import ServiceContainer from './ServiceContainer'; // Import ServiceContainer



const HomeServices = React.memo(() => {
    useEffect(() => {
    ...
    return (
        <div id='main2' className="services-section">
            <div id='page3' className='div-in-component'>
                <span className="page-component-heading ">Unmatched Service Spectrum</span>
                <p className="page-component-text pc-text">
                    We specialize in a diverse array of services designed to meet
                    every construction, fabrication, and interior design need. From conceptualization to completion, our
                    team excels in delivering high-quality solutions tailored to exceed expectations across projects
                    of all sizes and complexities.
                </p>
                <ServiceContainer /> 
                <span className="page-component-text pc-text">And more....</span>
            </div>
        </div>
    );
});
